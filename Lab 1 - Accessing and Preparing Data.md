...
Product, Geography, and Manufacturer information is in a Microsoft Excel file called bi_dimensions.xlsx in the USSales subfolder within the Data folder (/Data/USSales/).
 ...
 1. Click **Already have a Power BI Account? Sign in** option.

 1. **Sign in** using your Power BI credentials.

    > **Note**: Please use the **Username** and **Password** credentials details from the Environment Details tab.

 1. You will see the startup screen opens. Click on the **X** on the top right corner of the dialog box to close it.
...
1. From the ribbon, click **File**, then click **Options and settings**, then click **Options**.
 
    ![](Images/powerbi-01-03.png)
 
1. In the left panel of **Options** dialog box, click **Regional Settings** under Current File.

1. From the Locale drop-down, click **English (United States)**.
...
1. From the ribbon, click **Home** and then click the **Get Data** drop-down arrow.
...
1. Browse to **DIAD**, double-click **Data**, double-click the **USSales** folder, and then click **sales.csv**.
...
1. Click the **Open** button.
 ...
 1. Click Transform Data as shown in the screenshot. A new window opens.
...
1. Notice that Power BI has set the **Zip** field to the data type **Whole Number**. To ensure that the leading zero is not dropped from Zip codes that start with zero, we will format them as **Text**. To do this, select the **Zip column**. Then, from the ribbon, click **Home**, click **Data Type**, and change it to **Text**.

1. The **Change Column Type** dialog box opens. Click the **Replace Current** button which overwrites Power BI’s predicted data type.

    ![](Images/powerbi-01-09.png)
    
    Now let’s get the data that is in Excel source file.
    
1. From the ribbon, click **Home**, click **New Source**, and click then **Excel**.

    ![](Images/powerbi-01-10.png)
    
1. Browse to **DIAD**, double-click **Data**, double-click the **USSales** folder, and then click **bi_dimensions.xlsx**.

1. Click the **Open** button. The **Navigator** dialog box opens.

    ![](Images/powerbi-01-11.png)
    
1. The **Navigator** dialog box lists three sheets that are in the Excel workbook. It also lists the **Product** table. Click **product** in the panel on the left. In the preview panel, notice that the first row is the headers. This is not part of the data.

1. Now, deselect **product** from the left panel and click **Product_Table**. Notice that this table has only the contents of the named table. This is the data we need.

    ![](Images/powerbi-01-12.png)
    
  >**Note**: Table names are differentiated from Worksheet names by using different icons.
    
1. From the left panel, click **geo**. In the preview panel, notice that the first few rows are headers and are not part of the data. We will remove them shortly.

1. From the left panel, click **manufacturer**. In the preview panel, notice that the last couple of rows are footers and are not part of the data. We will remove them shortly.

1. Make sure that **Product_Table**, **geo** and **manufacturer** are selected in the left panel, and then click **OK**. Notice all that three sheets are added as queries in the Query Editor.
...
1. On the **Home** tab of the Query Editor, click on the **New Source** drop-down menu.

1. Click **More…** as shown in the figure.

    ![](Images/powerbi-01-14.png)
    
1. The Get Data dialog box opens.

1. In the **Get Data** dialog box, click **Folder** as shown in the diagram.

1. Click **Connect** and the **Folder** dialog box will open.

    ![](Images/powerbi-01-15.png)
    
1. Click the **Browse…** button.

1. In the **Browse** for Folder dialog box, navigate to the location where you unzipped the class files.

1. Open the **DIAD** folder.

1. Open the **Data** folder.

1. Click the **InternationalSales** folder.

1. Click **OK** (to close the **Browse for Folder** dialog box).

1. Click **OK** (to close the **Folder** dialog box).
...
1. If you do not see the **Queries** pane on left, click on the > (greater than) icon to expand. 

1. If you do not see the **Query Settings** pane on the right as shown in the figure, click on **View** in the ribbon and click **Query Settings** to see the pane. 
...
1. We do not need the **Source.Name** column. Click the **Source.Name** column and from the ribbon, click **Home**, click **Remove Columns**, and then click **Remove Columns** again.

    ![](Images/powerbi-01-22.png)
    
1. Next, click the drop-down menu next to the **Country** column to see the unique values. 

1. You will only see Australia as shown in the figure. By default, Power BI only loads the first 1000 rows. Click **Load more** to validate that you have data from the various countries included.

1. 

   ![](Images/powerbi-01-23.png)
   
1.  You will see the countries (blank), Australia, Canada, Germany, Japan, Mexico, and Nigeria.
